...
class _TelaCadastroState extends State<TelaCadastro> {
  ...
  bool _confirmaSenhaVisivel = false; // Para controlar a visibilidade da confirmação da senha
  ...
  Future<void> _selecionarDataNascimento() async {
    ...
    if (dataSelecionada != null) {
      ...
      _dataNascimentoController.text = dataFormatada; // Atualiza o campo de texto
    }
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16.0),
                GestureDetector(
                  onTap: _selecionarDataNascimento, // Abre o seletor de data ao tocar
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () => _registraUsuario(
                      ...
                      _confirmaSenhaController.text, // Passa a confirmação da senha
                    ),
...
/*
CODIGO COM TRATAMENTO DOS CAMPOS DE INSERÇÃO E FALTA A VERIFICAÇÃO DE CONFIRMAÇÃO DE SENHA
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import '/db_helper.dart';
...
/*
COM A OCULTAR E DESOCULTAR A SENHA
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import '/db_helper.dart';
...
/*
FUNCIONOU COM O MINI CALENDARIO
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import '/db_helper.dart';
